...
class SinkronisasiController extends Controller
{
  ...
  public function index()
  {
    ...
    $data = LimitApi::with('users')->latest()->first();
  ...
  public function get_data()
  {
    ...
    $limitApi->increment('usage_count', 2);
    // menghitung limit api
  ...
  public function get_data_2425()
  {
    $apiKey = env('API_KEY_SPREEDSHEET_2425');
    $baseUrl = 'https://sheetdb.io/api/v1/' . $apiKey;
    $cells = 'B7,C7,D7,E7,F7,G7,H7,I7,J7,K7,B8,C8,D8,E8,F8,G8,H8,I8,J8,K8,B9,C9,D9,E9,F9,G9,H9,I9,J9,K9,B10,C10,D10,E10,F10,G10,H10,I10,J10,K10,B11,C11,D11,E11,F11,G11,H11,I11,J11,K11,B12,C12,D12,E12,F12,G12,H12,I12,J12,K12,B13,C13,D13,E13,F13,G13,H13,I13,J13,K13,B14,C14,D14,E14,F14,G14,H14,I14,J14,K14,B15,C15,D15,E15,F15,G15,H15,I15,J15,K15,B16,C16,D16,E16,F16,G16,H16,I16,J16,K16,B17,C17,D17,E17,F17,G17,H17,I17,J17,K17,B18,C18,D18,E18,F18,G18,H18,I18,J18,K18,B19,C19,D19,E19,F19,G19,H19,I19,J19,K19,B20,C20,D20,E20,F20,G20,H20,I20,J20,K20,B21,C21,D21,E21,F21,G21,H21,I21,J21,K21,B22,C22,D22,E22,F22,G22,H22,I22,J22,K22,B23,C23,D23,E23,F23,G23,H23,I23,J23,K23,B24,C24,D24,E24,F24,G24,H24,I24,J24,K24,B25,C25,D25,E25,F25,G25,H25,I25,J25,K25,B26,C26,D26,E26,F26,G26,H26,I26,J26,K26,B27,C27,D27,E27,F27,G27,H27,I27,J27,K27,B28,C28,D28,E28,F28,G28,H28,I28,J28,K28,B29,C29,D29,E29,F29,G29,H29,I29,J29,K29,B30,C30,D30,E30,F30,G30,H30,I30,J30,K30,B31,C31,D31,E31,F31,G31,H31,I31,J31,K31,B32,C32,D32,E32,F32,G32,H32,I32,J32,K32,B33,C33,D33,E33,F33,G33,H33,I33,J33,K33,B34,C34,D34,E34,F34,G34,H34,I34,J34,K34,B35,C35,D35,E35,F35,G35,H35,I35,J35,K35,B36,C36,D36,E36,F36,G36,H36,I36,J36,K36,B37,C37,D37,E37,F37,G37,H37,I37,J37,K37,B38,C38,D38,E38,F38,G38,H38,I38,J38,K38,B39,C39,D39,E39,F39,G39,H39,I39,J39,K39,B40,C40,D40,E40,F40,G40,H40,I40,J40,K40?';
    ...
    for ($row = $startRow; $row <= $endRow; $row++) {
      ...
      if (mb_strtoupper($cellB) === $cellB) {
        ...
        $jenjang = ($row >= 32 && $row <= 36) ? 'PASCASARJANA' : 'SARJANA';
        $record = [
          ...
          'bayar_form_kipk' => $data['H' . $row] ?? null,
          'nim' => $data['I' . $row] ?? null,
          'bayar_ukt_reguler' => $data['J' . $row] ?? null,
          'bayar_ukt_rpl' => $data['K' . $row] ?? null,
  ...
  public function get_data_2526()
  {
    $apiKey = env('API_KEY_SPREEDSHEET_2526');
    $baseUrl = 'https://sheetdb.io/api/v1/' . $apiKey;
    ...
    for ($row = $startRow; $row <= $endRow; $row++) {
      ...
      if (mb_strtoupper($cellB) === $cellB) {
        ...
        $jenjang = ($row >= 31 && $row <= 35) ? 'PASCASARJANA' : 'SARJANA';
        $record = [
          'fakultas' => $currentFakultas,
          'prodi' => $cellB,
          'pelayanan_online' => $data['C' . $row] ?? null,
