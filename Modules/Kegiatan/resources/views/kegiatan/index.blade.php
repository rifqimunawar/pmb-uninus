...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('kegiatan.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
          aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('kegiatan.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('kegiatan.pdf') }}" class="btn btn-warning btn-sm">
          ...
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td class="d-flex justify-content-center align-items-center text-center">
                ...
                <a href="{{ route('kegiatan.destroy', $item->id) }}" data-confirm-delete="true">
