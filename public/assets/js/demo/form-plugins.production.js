...
var handleRenderDateRangePicker = function() {
    ...
    let selectedDate = start.format("MMMM D, YYYY") + " - " + end.format("MMMM D, YYYY");
    let startDate = start.format("Y-MM-DD");
    let endDate = end.format("Y-MM-DD");

    $("#advance-daterange span").html(selectedDate);
    $("#hasil-daterange").html(selectedDate);
    $("#input-daterange").val(selectedDate);
